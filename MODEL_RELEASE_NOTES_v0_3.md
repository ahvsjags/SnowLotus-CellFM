...
The active v0.3 run remains in epoch 8, step 31750 of 56022. The release uses the validation-best audited checkpoint rather than the latest in-progress state.

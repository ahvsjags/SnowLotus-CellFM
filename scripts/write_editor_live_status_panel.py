...
TRAIN_PROGRESS = Path("outputs/foundation_5090_mlm_public_expansion_continuation/progress_latest.json")
RELEASE_DIR = Path("outputs/github_release/SnowLotus-CellFM")
GSE_ACCESSION = "GSE226826"
GSE_LOG = Path("logs/geo_promotion_gse226826.log")
GSE_WATCHDOG_LOG = Path("logs/geo_promotion_gse226826_watchdog.log")
GSE_MANIFEST = Path("data/corpus_manifest.gse226826.tsv")
GSE_DOWNLOAD_DIR = Path("data/public/GSE226826_rds")
...
def render_md(panel: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Running loss: `{training.get('running_train_losses', {}).get('loss', 'unknown')}`",

...
DEFAULT_PATTERNS = [
    ...
    "outputs/publication_package/annotation_bundles/**/*.json",
    "outputs/publication_package/annotation_bundles/**/*.csv",
    "outputs/publication_package/annotation_bundles/**/*.npy",
    ...
    "outputs/publication_package/benchmarks/v2/**/*.json",
    "outputs/publication_package/benchmarks/v2/**/*.md",
    "outputs/publication_package/benchmarks/v2/**/*.tsv",
    "outputs/publication_package/benchmarks/v2_lora/**/*.json",
    "outputs/publication_package/benchmarks/v2_lora/**/*.md",
    "outputs/publication_package/benchmarks/v3/**/*.json",
    "outputs/publication_package/benchmarks/v3/**/*.md",
    "outputs/publication_package/benchmarks/v3/**/*.tsv",
    "outputs/publication_package/benchmarks/v3_extended/**/*.json",
    "outputs/publication_package/benchmarks/v3_extended/**/*.md",
    "outputs/publication_package/benchmarks/v3_extended/**/*.tsv",
    "outputs/publication_package/benchmarks/v4/**/*.json",
    "outputs/publication_package/benchmarks/v4/**/*.md",
    "outputs/publication_package/benchmarks/v4/**/*.tsv",
    "outputs/publication_package/benchmarks/v5/**/*.json",
    "outputs/publication_package/benchmarks/v5/**/*.md",
    "outputs/publication_package/benchmarks/v5/**/*.tsv",
    "outputs/publication_package/benchmarks/v6/**/*.json",
    "outputs/publication_package/benchmarks/v6/**/*.md",
    "outputs/publication_package/benchmarks/v6/**/*.tsv",
    "outputs/publication_package/benchmarks/v3_seed/**/*.json",
    "outputs/publication_package/benchmarks/v3_seed/**/*.md",
    "outputs/publication_package/benchmarks/v3_seed/**/*.tsv",
    ...
    "outputs/publication_package/strict_benchmarks/v3/**/*.json",
    "outputs/publication_package/strict_benchmarks/v3_seed/**/*.json",
    "outputs/publication_package/strict_benchmarks/v3_extended/**/*.json",
    "outputs/publication_package/strict_benchmarks/v4/**/*.json",
    "outputs/publication_package/strict_benchmarks/v5/**/*.json",
    "outputs/publication_package/strict_benchmarks/v6/**/*.json",
    "outputs/publication_package/strict_benchmarks/interim_gpu/**/*.json",
    "outputs/publication_package/v2_training/*.log",
    "outputs/publication_package/v3_training/*.log",
    "outputs/publication_package/v3_seed_training/*.log",
    "outputs/publication_package/v3_extended_training/*.log",
    "outputs/publication_package/v4_training/*.log",
    "outputs/publication_package/v5_training/*.log",
    "outputs/publication_package/v6_training/*.log",
    "outputs/publication_package/interim_gpu_training/*.log",

...
export SNOWCELL_GEO_ACCESSION=GSE275267
export SNOWCELL_GEO_DATASET_ID=geo_gse275267_arabidopsis_thaliana_an_antagonistic_epigenetic_mechanism_regulating

...
export SNOWCELL_GEO_ACCESSION=GSE275693
export SNOWCELL_GEO_DATASET_ID=geo_gse275693_arabidopsis_thaliana_an_antagonistic_epigenetic_mechanism_regulating

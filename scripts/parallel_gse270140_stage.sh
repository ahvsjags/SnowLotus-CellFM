...
/root/miniconda3/envs/myconda/bin/python "${PROJECT_DIR}/scripts/parallel_geo_range_resume.py" \
  --url "https://ftp.ncbi.nlm.nih.gov/geo/samples/GSM8339nnn/GSM8335426/suppl/GSM8335426_JWE03_filtered_feature_bc_matrix.h5" \
  --output "${h5_path}" --expected-bytes 68904043 --workers 8

...
def main() -> None:
    ...
    retired_assets = V12 / "assets"
    asset_records: dict[str, object] = {"scripted_vector_schematics": "No generative-image assets are required by the v12 renderers."}
    if retired_assets.exists() and any(retired_assets.iterdir()):
        failures.append("retired generative-image asset directory is not empty")
    ...
    payload = {
        ...
        "scope": "seven main figures; four-format 600-dpi exports; editable vector typography and data layers; SVG/PDF embedded-raster effective dpi; source-data completeness; key row counts; visual occupancy; scripted vector schematics",
        "figures": records,
    ...
    lines = [
        ...
        "- Source-table counts, key row counts, editable typography, vector data-layer renderers, SVG/PDF embedded-raster dpi, visual occupancy and scripted-vector mechanism panels were audited.",
        "",

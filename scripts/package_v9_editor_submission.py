...
ASSET_PATHS = [
    ...
    "manuscript/Plant_CellFM_v9_cover_letter.docx",
    "manuscript/Plant_CellFM_v9_english_submission_synopsis.md",
    "manuscript/Plant_CellFM_v9_english_submission_synopsis.docx",
    ...
    "release_metadata/final_handoff_summary_v9.json",
    "release_metadata/data_code_availability_v9.md",
    "release_metadata/data_code_availability_v9.json",
    "release_metadata/submission_highlights_v9.md",
    "release_metadata/submission_highlights_v9.json",
    ...
    "release_metadata/third_party_benchmark_contract_v10.json",
    ...
    "release_metadata/cross_species_classifier_benchmark_v10.json",
    "release_metadata/revision_v11_fewshot_adapter_benchmark.md",
    "release_metadata/revision_v11_fewshot_adapter_benchmark.json",
    "release_metadata/revision_v11_runtime_head_benchmark.md",
    "release_metadata/revision_v11_runtime_head_benchmark.json",
    "release_metadata/revision_v13_neural_zero_shot_stc.md",
    "release_metadata/revision_v13_neural_zero_shot_stc.json",
    "release_metadata/revision_v14_context_stc_benchmark.md",
    "release_metadata/revision_v14_context_stc_benchmark.json",
    "release_metadata/revision_v15_runtime_teacher_rescue.md",
    "release_metadata/revision_v15_runtime_teacher_rescue.json",
    "release_metadata/revision_v11_third_party_closure.md",
    "release_metadata/revision_v11_third_party_closure.json",
    "release_metadata/algorithm_innovation_v10.md",
    "release_metadata/algorithm_innovation_v10.json",
    "release_metadata/algorithm_innovation_v14.md",
    "release_metadata/algorithm_innovation_v14.json",
    ...
    "release_metadata/open_set_calibration_v9.json",
    "release_metadata/open_set_calibration_exact_curve_v9.tsv",
    "release_metadata/open_set_calibration_ontology_curve_v9.tsv",
    "release_metadata/api_confidence_calibration_curve_v9.tsv",
    ...
    "release_metadata/multispecies_scplantdb_case_v10.json",
    "release_metadata/multispecies_scplantdb_marker_candidates_v10.tsv",
    "release_metadata/submission_scorecard_v11.md",
    "release_metadata/submission_scorecard_v11.json",
    "release_metadata/submission_scorecard_v14.md",
    "release_metadata/submission_scorecard_v14.json",
    "release_metadata/submission_scorecard_v15.md",
    "release_metadata/submission_scorecard_v15.json",
    ...
    "scripts/run_cross_species_classifier_benchmark_v10.py",
    "scripts/run_revision_v11_fewshot_adapter_benchmark.py",
    "scripts/run_revision_v11_runtime_head_benchmark.py",
    "scripts/run_revision_v12_zero_shot_stc_benchmark.py",
    "scripts/run_revision_v13_neural_zero_shot_stc.py",
    "scripts/run_revision_v14_context_stc_benchmark.py",
    "scripts/run_revision_v15_runtime_teacher_rescue.py",
    "scripts/write_revision_v11_third_party_closure.py",
    "scripts/write_algorithm_innovation_v10.py",
    "scripts/run_open_set_calibration_v9.py",
    "scripts/write_multispecies_scplantdb_case_v10.py",
    "scripts/write_third_party_benchmark_contract_v10.py",
    "scripts/write_submission_scorecard_v11.py",
    "scripts/verify_v9_server_release.py",
    "scripts/write_release_gate_completion_audit_v9.py",
    "scripts/write_final_handoff_summary_v9.py",
...
def package_readme(git_head: str, generated_at: str) -> str:
    return "\n".join(
        [
            ...
            "4. `release_metadata/final_handoff_summary_v9.md`",
            "5. `manuscript/Plant_CellFM_v9_cover_letter.docx`",
            "6. `manuscript/Plant_CellFM_v9_english_submission_synopsis.docx`",
            "7. `release_metadata/submission_highlights_v9.md`",
            "8. `release_metadata/data_code_availability_v9.md`",
            "9. `release_metadata/v9_editor_issue_closure.md`",
            "10. `release_metadata/publication_peer_review_preflight_v9.md`",
            "11. `release_metadata/top_journal_readiness_matrix.md`",
            "12. `release_metadata/arabidopsis_root_case_figure_v9.md`",
            "13. `release_metadata/species_holdout_failure_audit_v9.md`",
            "14. `release_metadata/species_ontology_coverage_audit_v9.md`",
            "15. `release_metadata/species_ontology_label_benchmark_v9.md`",
            "16. `release_metadata/cross_species_classifier_benchmark_v10.md`",
            "17. `release_metadata/revision_v11_fewshot_adapter_benchmark.md`",
            "18. `release_metadata/revision_v11_runtime_head_benchmark.md`",
            "19. `release_metadata/revision_v13_neural_zero_shot_stc.md`",
            "20. `release_metadata/revision_v14_context_stc_benchmark.md`",
            "21. `release_metadata/revision_v15_runtime_teacher_rescue.md`",
            "22. `release_metadata/revision_v11_third_party_closure.md`",
            "23. `release_metadata/algorithm_innovation_v14.md`",
            "24. `release_metadata/open_set_calibration_v9.md`",
            "25. `release_metadata/third_party_benchmark_contract_v10.md`",
            "26. `release_metadata/multispecies_scplantdb_case_v10.md`",
            "27. `release_metadata/submission_scorecard_v15.md`",
            "28. `release_metadata/server_sustainability_status_v9.md`",
            "29. `scripts/verify_v9_server_release.py`",
            "30. `scripts/write_release_gate_completion_audit_v9.py`",
            "31. `GITHUB_SYNC_RECOVERY.md`",
            "",
            "## Claim Boundary",
            "",
            "This package supports a Plant-CellFM v9 computational method/resource submission: general plant single-cell expression modelling, all-plant adapter resolution, completed v3/centroid/Seurat comparisons, v11 few-shot target-adapter calibration, v13 neural zero-shot STC diagnostics, v14 context-aware strict zero-shot STC rescue, v15 runtime-teacher deployment rescue, open-set calibration and selective annotation audit, third-party benchmark contracts and closure audit, Arabidopsis root and multi-species scPlantDB computational biology cases, live CUDA service evidence and watchdog recovery evidence.",
            "",
            ...
            "",
            "Cross-species generalization is reported with the normalized leave-species-out metrics, `release_metadata/species_holdout_failure_audit_v9.md`, `release_metadata/species_ontology_coverage_audit_v9.md`, `release_metadata/species_ontology_label_benchmark_v9.md`, `release_metadata/cross_species_classifier_benchmark_v10.md`, `release_metadata/revision_v11_fewshot_adapter_benchmark.md`, `release_metadata/revision_v11_runtime_head_benchmark.md`, `release_metadata/revision_v13_neural_zero_shot_stc.md`, `release_metadata/revision_v14_context_stc_benchmark.md`, `release_metadata/revision_v15_runtime_teacher_rescue.md`, `release_metadata/algorithm_innovation_v14.md` and `release_metadata/open_set_calibration_v9.md`, which separate open-set label absence, known-label transfer errors, ontology-actionable labels, ontology-label benchmark accuracy, species-transfer calibration, target-species adapter calibration, runtime-head open-set rescue, phylogeny/organ-gated strict zero-shot STC, confidence-aware selective annotation and per-species revision targets. Under the same held-out species denominator and frozen runtime embeddings, v14 raises strict all-cell STC accuracy from the honest 30.10% baseline to 42.36% while retaining the 55.90% open-set coverage boundary. v15 then reports a separate deployment/readiness protocol: teacher-rescue with v14 fallback reaches 60.09% all-cell accuracy and the full runtime annotation head reaches 66.25% all-cell accuracy on the same 3,964 aligned cells.",
            "",
            "## GitHub Sync State",
            "",
            ...
            "",
            "`release_metadata/submission_scorecard_v15.md` records the current evidence-readiness dimensions while explicitly keeping official scPlantLLM/scPlantAnnotate metrics and wet-lab validation as non-inflated limits. The strict zero-shot STC weakness is addressed by the v14 context-aware benchmark, and the deployment/readiness weakness is addressed by the v15 runtime-teacher rescue benchmark.",
            "",
            "Post-v9 continuation logs that did not improve the submission claim are kept outside this editor zip. The included v13/v14/v15 continuation artifacts are retained because they close the strict zero-shot STC revision target and add a clearly separated deployment/readiness metric under documented protocol boundaries.",
            "",
        ]
    )

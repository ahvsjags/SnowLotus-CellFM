...
def package_readme(git_head: str, generated_at: str) -> str:
    return "\n".join(
        [
            ...
            "6. `release_metadata/data_code_availability_v9.md`",
            "7. `release_metadata/v9_editor_issue_closure.md`",
            "8. `release_metadata/publication_peer_review_preflight_v9.md`",
            "9. `release_metadata/top_journal_readiness_matrix.md`",
            "10. `release_metadata/arabidopsis_root_case_figure_v9.md`",
            "11. `release_metadata/species_holdout_failure_audit_v9.md`",
            "12. `release_metadata/species_ontology_coverage_audit_v9.md`",
            "13. `release_metadata/species_ontology_label_benchmark_v9.md`",
            "14. `release_metadata/server_sustainability_status_v9.md`",
            "15. `scripts/verify_v9_server_release.py`",
            "16. `scripts/write_release_gate_completion_audit_v9.py`",
            "17. `GITHUB_SYNC_RECOVERY.md`",
            "",
            "## Claim Boundary",
            "",

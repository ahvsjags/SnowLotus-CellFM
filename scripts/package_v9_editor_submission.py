...
def package_readme(git_head: str, generated_at: str) -> str:
    return "\n".join(
        [
            ...
            "20. `release_metadata/server_continuation_status_v10.md`",
            "21. `release_metadata/current_publication_state_v10.md`",
            "22. `scripts/write_server_continuation_status_v10.py`",
            ...
            "",
            "Post-v9 continuation is documented separately in `docs/post_v9_continuation_operations.md`, `release_metadata/server_continuation_status_v10.md` and `release_metadata/current_publication_state_v10.md`. It records the disk-budget watcher, `/root` staging path, scPlantDB budgeted H5AD queue, completed 2-epoch diagnostic v10 LoRA continuation and continuation-status script used when `/mnt` is full. These continuation assets are evidence of ongoing reproducible work and do not expand or replace the frozen v9 claims.",
            "",
        ]
    )

...
def package_readme(git_head: str, generated_at: str) -> str:
    return "\n".join(
        [
            ...
            "17. `release_metadata/algorithm_innovation_v10.md`",
            "18. `release_metadata/open_set_calibration_v9.md`",
            "19. `release_metadata/third_party_benchmark_contract_v10.md`",
            "20. `release_metadata/multispecies_scplantdb_case_v10.md`",
            "21. `release_metadata/submission_scorecard_v11.md`",
            "22. `release_metadata/server_sustainability_status_v9.md`",
            "23. `scripts/verify_v9_server_release.py`",
            "24. `scripts/write_release_gate_completion_audit_v9.py`",
            "25. `GITHUB_SYNC_RECOVERY.md`",
            "",
            "## Claim Boundary",
            "",
            "This package supports a Plant-CellFM v9 computational method/resource submission: general plant single-cell expression modelling, all-plant adapter resolution, completed v3/centroid/Seurat comparisons, open-set calibration and selective annotation audit, third-party benchmark contracts, Arabidopsis root and multi-species scPlantDB computational biology cases, live CUDA service evidence and watchdog recovery evidence.",
            "",

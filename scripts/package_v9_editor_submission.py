...
def package_readme(git_head: str, generated_at: str) -> str:
    return "\n".join(
        [
            ...
            "16. `release_metadata/open_set_calibration_v9.md`",
            "17. `release_metadata/third_party_benchmark_contract_v10.md`",
            "18. `release_metadata/multispecies_scplantdb_case_v10.md`",
            "19. `release_metadata/submission_scorecard_v11.md`",
            "20. `release_metadata/server_sustainability_status_v9.md`",
            "21. `scripts/verify_v9_server_release.py`",
            "22. `scripts/write_release_gate_completion_audit_v9.py`",
            "23. `GITHUB_SYNC_RECOVERY.md`",
            "",
            "## Claim Boundary",
            "",
            ...
            "",
            "Cross-species generalization is reported with the normalized leave-species-out metrics, `release_metadata/species_holdout_failure_audit_v9.md`, `release_metadata/species_ontology_coverage_audit_v9.md`, `release_metadata/species_ontology_label_benchmark_v9.md` and `release_metadata/open_set_calibration_v9.md`, which separate open-set label absence, known-label transfer errors, ontology-actionable labels, ontology-label benchmark accuracy, confidence-aware selective annotation and per-species revision targets.",
            "",
            "## GitHub Sync State",
            "",

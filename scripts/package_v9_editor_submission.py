...
def package_readme(git_head: str, generated_at: str) -> str:
    return "\n".join(
        [
            ...
            "19. `release_metadata/revision_v11_third_party_closure.md`",
            "20. `release_metadata/algorithm_innovation_v10.md`",
            "21. `release_metadata/open_set_calibration_v9.md`",
            "22. `release_metadata/third_party_benchmark_contract_v10.md`",
            "23. `release_metadata/multispecies_scplantdb_case_v10.md`",
            "24. `release_metadata/submission_scorecard_v11.md`",
            "25. `release_metadata/server_sustainability_status_v9.md`",
            "26. `scripts/verify_v9_server_release.py`",
            "27. `scripts/write_release_gate_completion_audit_v9.py`",
            "28. `GITHUB_SYNC_RECOVERY.md`",
            "",
            "## Claim Boundary",
            "",
            "This package supports a Plant-CellFM v9 computational method/resource submission: general plant single-cell expression modelling, all-plant adapter resolution, completed v3/centroid/Seurat comparisons, v11 few-shot target-adapter calibration, v11 runtime-head audit, open-set calibration and selective annotation audit, third-party benchmark contracts and closure audit, Arabidopsis root and multi-species scPlantDB computational biology cases, live CUDA service evidence and watchdog recovery evidence.",
            "",
            ...
            "",
            "`release_metadata/submission_scorecard_v11.md` records the current 90+ evidence-readiness dimensions while explicitly keeping raw leave-species accuracy, official scPlantLLM/scPlantAnnotate metrics and wet-lab validation as non-inflated limits.",
            "",
            "Post-v9 continuation logs are kept outside this editor zip. The frozen package uses only v9 submission evidence plus the multi-species scPlantDB public-data biology case; exploratory continuation checkpoints are not presented as publication-model performance.",
            "",
        ]
    )

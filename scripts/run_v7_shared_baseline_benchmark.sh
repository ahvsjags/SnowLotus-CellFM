...
OUTPUT="${SNOWCELL_V7_SHARED_BASELINE_OUTPUT:-${V7_ROOT}/v3_on_v7_shared_subset_cross_species_benchmark.json}"
LOG="${SNOWCELL_V7_SHARED_BASELINE_LOG:-${V7_ROOT}/v3_on_v7_shared_subset_cross_species_benchmark.log}"
...
echo "v7 shared baseline benchmark complete: ${OUTPUT}"

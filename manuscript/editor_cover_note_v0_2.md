...
The main contribution is a reproducible framework for plant single-cell target-species transfer under realistic public-data constraints. The current audit covers 69 manifest files, 210 readable matrix files and 4,072,521 referenced cells, with 0 missing and 0 unreadable matrices. The frozen embedding checkpoint is the v0.3 validation-best asset from epoch 7 with eval loss 7.1917; the supervised annotation checkpoint carries macro-F1 evidence of 0.8121.

...
For the editor snapshot, the frozen embedding asset is the v0.3 best checkpoint from `outputs/foundation_5090_mlm_public_expansion_continuation_v0_3_seed47_b8_vocabwarm/best.pt`. It reached validation eval loss 7.2026 at epoch 6, and its SHA256 is `ed90abffeb110fca3e5a4eb11fefc18cd0198b09669341002971b89eb664bf4c`. Training remains active in epoch 7, at step 23250 of 56022 batches per epoch at the time of this manuscript refresh. The package freezes the best audited checkpoint rather than the most recent in-progress state, so the submitted model asset is reproducible even while background training continues.

...
**Plant Methods submission package: PASS after four-blocker repair.** The scientific text, main figures, source manifests and Word files are now aligned around a coverage-aware cross-species annotation claim. Author names, affiliations and corresponding-author details still need to be entered by the submitting author.
...
- Main DOCX rebuilt: `Plant_CellFM_Plant_Methods_manuscript_v1.docx`, 32,884 bytes.
- Supporting DOCX rebuilt: `Plant_CellFM_Plant_Methods_supporting_information_v1.docx`, 22,826 bytes.
- Cover letter DOCX rebuilt: `Plant_CellFM_Plant_Methods_cover_letter_v1.docx`, 10,800 bytes.

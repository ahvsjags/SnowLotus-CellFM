...
- The Fig. 2 context panel presents a method sequence only with its global-selection boundary written in the panel, caption and evidence ledger.
- The Fig. 3 protocol panel makes support/query separation and the fixed repeat-sampling contract visible before the dose-response curves are interpreted.

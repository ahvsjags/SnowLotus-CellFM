...
- Visual review: `88.0/100` (expert_reviewed_v4_data_first_draft)
...
| Fig. 4 | 88/100 | Identity hierarchy, effect size, detection separation and ranked candidate programs are readable. The scientific evidence remains a public-data candidate resource pending independent validation. |

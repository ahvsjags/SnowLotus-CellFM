...
- Focus accession: `GSE226826`
- Manifest ready: `True`
- Manifest rows: `1`
- Latest download progress: `105MiB/105MiB (99%)`
- Latest speed: `20KiB`
- Latest ETA: `None`

## Release package

- Release directory: `outputs/github_release/SnowLotus-CellFM`
- Git LFS model files: `2`
- SHA256 check return code: `0`

## GitHub publication status

- Remote check return code: `128`
- Remote check stderr: `git@github.com: Permission denied (publickey).
...
- `snowcell_mlm_public_expansion_v0_4_after_v0_3_watchdog: 1 windows (created Sun Jul 26 01:50:52 2026)`

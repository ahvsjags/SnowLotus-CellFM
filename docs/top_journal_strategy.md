...
3. 基于已完成的 ontology-label species-holdout benchmark，进入模型侧改进：species adapter calibration、open-set rejection、ortholog-aware tokenization 或独立物种复现实验。

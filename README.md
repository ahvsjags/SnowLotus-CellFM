...
- Best embedding checkpoint: `foundation_5090_mlm_public_expansion_continuation_v0_3_seed47_b8_vocabwarm/best.pt`, SHA256 `ed90abffeb110fca3e5a4eb11fefc18cd0198b09669341002971b89eb664bf4c`
- Current best evidence: v0.3 epoch-6 evaluation loss 7.2026 after vocabulary-aware warm-start from the completed v0.2 continuation; v0.3 epoch-7 training is still running and will be superseded only after passing the same audit gates
